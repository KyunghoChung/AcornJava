...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        iFirstVal = sc.nextInt();
        System.out.println("두번째 숫자 입력:");
        iSecondVal = sc.nextInt();
    ...
    public static int sub(int FirstVal, int SecondVal){
        int result;
        result = FirstVal - SecondVal;
        return result;
    }
    public static int mul(int FirstVal, int SecondVal){
        int result;
        result = FirstVal * SecondVal;
        return result;
    }
    public static double div(int FirstVal, int SecondVal){
        double result;
        if(FirstVal == 0){
            return 0;
        }
